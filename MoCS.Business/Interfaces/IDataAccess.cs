...
namespace MoCS.Business
{
    public interface IDataAccess
    {
        ...
        AssignmentEnrollment GetTeamTournamentAssignmentById(int id);
        List<AssignmentEnrollment> GetTeamTournamentAssignmentsForTeam(int tournamentId, int teamId);
        ...
        AssignmentEnrollment SaveTeamTournamentAssignment(AssignmentEnrollment tta);
