...
namespace MoCS.Client.Business
{
    public class TournamentReportGenerator
    {
        ...
        private static XmlNode AppendRankingNode(XmlNode parentnode, string description, Team t, Submit s)
        {
            ...
            AppendAttribute(node, "teamname", t.TeamName);
            AppendAttribute(node, "teammembers", t.TeamMembers);
                                ...
                                , List<Submit> submits)
        {
            ...
            foreach (Team t in teams)
            {
                ...
                AppendAttribute(teamNode, "name", t.TeamName);
                AppendAttribute(teamNode, "members", t.TeamMembers);
