...
namespace MoCS.WebClient.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(IFormsAuthenticationService formsService, IMembershipService membershipService)
        {
            ...
            MembershipService = membershipService ?? new AccountMembershipService(new MoCSMembershipProvider());
        }
        ...
        public ActionResult LogOff()
        {
            ...
            //THT reset password and other session data in the Session object
            Session.Remove("password");
            Session.Remove("tournamentId");
            Session.Remove("tournamentName");
        ...
        public ActionResult LogOn(LogOnModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                if (MembershipService.ValidateUser(model.UserName, model.Password))
                {
                    ...
                    //THT cache password in the Session object
